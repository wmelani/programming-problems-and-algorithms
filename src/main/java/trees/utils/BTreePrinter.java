...
/**
 * This class is taken from stackoverflow post by michal.kreuzman with minor modifications
 * to support BinaryTreeNode syntax
...
public class BTreePrinter {
    ...
    private static <T extends Comparable<T>> void printNodeInternal(
            List<BinaryTreeNode<T>> nodes, int level, int maxLevel) {
